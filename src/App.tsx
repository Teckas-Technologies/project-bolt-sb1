    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <a href='https://calendly.com/immanuel-teckastechnologies/aireadysaas' target='_blank'><button className="group bg-blue-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-blue-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl">
              ...
              <button onClick={handleDemoRequest}className="group border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-lg text-lg font-semibold hover:border-blue-600 hover:text-blue-600 hover:shadow-lg transition-all duration-300">
                📩 Request Sample Integration Demo
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up" style={{animationDelay: '0.4s'}}>
          <a href='https://calendly.com/immanuel-teckastechnologies/aireadysaas' target='_blank'> <button className="group bg-white text-blue-600 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-gray-100 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl">
              👉 Book Free Audit Call
              <ArrowRight className="inline ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform duration-200" />
            </button></a>
            <button onClick={handleDemoRequest} className="group border-2 border-white text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-white hover:text-blue-600 transition-all duration-300 hover:shadow-lg">
              📩 Request Sample Integration Demo
              <span className="inline-block ml-2 transform group-hover:scale-110 transition-transform duration-200">🔗</span>
            </button>
          </div>
